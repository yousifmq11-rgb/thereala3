...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    descFi: "Asennustyö 250 €. Hankimme vetokoukun puolestasi — osien hinta lisätään erikseen.",
    descEn: "Labour 250€. We source the tow hook for you — parts cost added separately.",
